    ...
    <div>
      ...
      <section className="project-section">
        ...
        <p>
          I thought:{" "}
          <strong>
            "Wouldn't it be cool if we got a chance to get to know M19?"
          </strong>{" "}
          and got cracking at what I dubbed 'Blind Minervating'. It was a
          complicated workflow I cobbled together in a few days and rolled out.
        </p>
        <ImageWithCaption
