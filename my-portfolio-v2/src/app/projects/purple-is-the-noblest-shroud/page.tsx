...
How did she do it?"
        ...
        <p>
          ...
          little to occupy my time. I'd just completed a virtual walking tour of
          Hyderabad for my history class and was thinking of making a series of
          similar videos. But I found an opportunity with the{" "}
          ...
          with Eric Koester that I'd find myself taking my first steps on the
          journey to becoming a published author.
        </p>
        <p>
          I hadn't the slightest idea what I would write about, but as I was
          rewatching{" "}
        ...
        <p>
          ...
          writing, the crafting and you can bet there's going to be a sequel!
        </p>
      </section>
