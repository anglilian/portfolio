    ...
    <div>
      ...
      <section className="project-section">
        ...
        <p>
          ...
          Hyderabad's history. Rich as it is, it deserved illustrations or image
          and audio based primary sources that better convey the narrative,
          which I didn't have time to create or research. If I was still in
          Hyderabad, I would have attended more walking tours and conducted
          interviews with locals to uncover stories about Hyderabad and
          understand which parts of their history is central to them.
