  ...
  return (
    <div>
      ...
      <section className="project-section">
        <p>
          As Manai's Student Experience and Curriculum Designer, one of my tasks
          was to design a research project for the 25 students from all over the
          world coming to Hokkaido to attend Manai's Summer Program. The goal of
          the research project was for students to gain practical experience in
          scientific research and inspire them to do what they love.
        </p>
        <p>
...
"
        ></QuoteBox>
        <p>
          I worked with Fred Junghans, Manai's Lead Research Mentor, to develop
          a program that would teach our students the basics of enzymes and
          molecular processes which would equip them with the skills to
        ...
        <p>
          I've always mused that in another life I would have been a doctor or
          taken a more natural sciences focused route. This experience gave me a
          taste of a life I would be happy to live in my next lifetime.
        </p>
      </section>
      <footer className="project-footer">
        ...
        >
          <p>
            Produce innovators who solves the world’s challenges using science
            and technology as a tool to create a new world.
          </p>
        </Section>
        <Section
          title="Mistletoe inc.
