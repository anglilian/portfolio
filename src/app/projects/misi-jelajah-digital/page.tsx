    ...
    <div>
      ...
      <section className="project-section">
        <p>
          ...
          their STEM competition which they were hosting under eKelas,
          Maxis&apos;s flagship community program for free and accessible
          digital learning. The STEM competition aimed to inspire students to
          pursue their interest in STEM and provide resources to further their
          learning.
        </p>
        <p>
